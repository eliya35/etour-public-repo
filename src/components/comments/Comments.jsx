...
const Comments = ({ tour_site_id }) => {
    ...
    const getReplies = commentId => {
        return backendComments.filter(backendComment => backendComment.parent_id === commentId)
            .sort(
                (a, b) =>
    ...
    const updateComment = async (body, commentId) => {
        ...
        await axios.patch(
            `https://etour.herokuapp.com/HDp0mdCOWxaBRhELG5PUMWQnrXSkObDQBnvUhC5XsTROlI6Wz99ctDZtzRLqHuvgidz0mX3ws3K6ggPc8p21OT2jwEcbpNMDHcHrxb0EoN7al1aP8fKoSpZMyXvL9FxnkJuS2KG5r1d8YkjyYjgCj2V44GdYk6ehB7JJuqoE6wAZWe5VisNMKnFYfS40mhymtJNFb8Aq/comments/${commentId}/`, data
        )
            .then(() => {
    ...
    useEffect(
        () => {
            ...
            axios.get(
                ...
                .catch(() => {/*TODO: Impliment error boundary */ })
