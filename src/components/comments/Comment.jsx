    ...
    return (
        <div className='comment'>
            <div className="comment-image-container">
                {comment.comment_profile !== null ? <img src={comment.comment_profile} className='user-profile-img' alt="profile" /> : <img src="https://etour-first-backet.s3.amazonaws.com/avatars/user-icon.png" alt="profile" />}
