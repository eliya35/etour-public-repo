...
urlpatterns = [
    ...
    path('region/USA/', TemplateView.as_view(template_name='index.html'), name = "usa_region"),
    ...
    path('region/Middle-East/', TemplateView.as_view(template_name='index.html'),name = "middleeast_region"),
